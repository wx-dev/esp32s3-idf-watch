...
void ui_Weather_screen_init(void)
{
    ...
    lv_obj_set_x(ui_Pary_Cloud, -56);
    lv_obj_set_y(ui_Pary_Cloud, -7);
    ...
    lv_obj_set_style_text_font(ui_Pary_Cloud, &lv_font_montserrat_14, LV_PART_MAIN | LV_STATE_DEFAULT);

    ui_New_York = ui_Small_Label_create(ui_Weather);
    lv_obj_set_x(ui_New_York, 44);
    lv_obj_set_y(ui_New_York, -8);
    ...
    lv_obj_set_x(ui_Cloud, 24);
    lv_obj_set_y(ui_Cloud, 21);
    ...
    lv_obj_set_x(ui_Celsius, 46);
    lv_obj_set_y(ui_Celsius, 26);
