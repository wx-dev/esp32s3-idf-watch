...
void ui_Call_screen_init(void)
{
    ...
    lv_obj_set_style_text_font(ui_Elena, &lv_font_montserrat_14, LV_PART_MAIN | LV_STATE_DEFAULT);

    ui_Incoming = ui_Small_Label_create(ui_Call);
    lv_obj_set_x(ui_Incoming, 0);
    lv_obj_set_y(ui_Incoming, 28);
    ...
    lv_obj_set_style_text_font(ui_Incoming, &lv_font_montserrat_14, LV_PART_MAIN | LV_STATE_DEFAULT);

    ui_Call_Incon1 = lv_obj_create(ui_Call);
    lv_obj_set_width(ui_Call_Incon1, 40);
    lv_obj_set_height(ui_Call_Incon1, 40);
    lv_obj_set_x(ui_Call_Incon1, -59);
    lv_obj_set_y(ui_Call_Incon1, -34);
    ...
    lv_obj_set_width(ui_Call_Incon2, 40);
    lv_obj_set_height(ui_Call_Incon2, 40);
    lv_obj_set_x(ui_Call_Incon2, 49);
    lv_obj_set_y(ui_Call_Incon2, -34);
