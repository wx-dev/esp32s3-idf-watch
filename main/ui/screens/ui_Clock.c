...
void ui_Clock_screen_init(void)
{
    ...
    lv_obj_set_width(ui_Clock_Panel, 140);
    lv_obj_set_height(ui_Clock_Panel, 140);
    lv_obj_set_x(ui_Clock_Panel, 2);
    lv_obj_set_y(ui_Clock_Panel, 18);
    ...
    lv_obj_set_y(ui_Clock_Number, 12);
    lv_obj_set_align(ui_Clock_Number, LV_ALIGN_TOP_MID);
    lv_label_set_text(ui_Clock_Number, "09:25");
    lv_obj_set_style_text_color(ui_Clock_Number, lv_color_hex(0x1A33F3), LV_PART_MAIN | LV_STATE_DEFAULT);
