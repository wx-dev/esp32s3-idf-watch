...
void ui_Music_Player_screen_init(void)
{
    ...
    lv_obj_set_style_text_font(ui_Music_Title, &lv_font_montserrat_14, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui_Author, &lv_font_montserrat_14, LV_PART_MAIN | LV_STATE_DEFAULT);

    ui_Play_btn = lv_obj_create(ui_Music_Player);
    lv_obj_set_width(ui_Play_btn, 40);
    lv_obj_set_height(ui_Play_btn, 40);
    lv_obj_set_x(ui_Play_btn, 0);
    lv_obj_set_y(ui_Play_btn, -35);
